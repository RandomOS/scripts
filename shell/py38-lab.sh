...
# wget -q -O - https://randomk.coding.net/p/misc/d/scripts/git/raw/master/shell/py38-lab.sh | bash -s py38-lab
# wget -q -O - https://randomk.coding.net/p/misc/d/scripts/git/raw/master/shell/py38-lab.sh | sh
...
if [ $? -ne 0 ]; then
    if [ -x "$(command -v docker)" ]; then
        ...
        if [ $? -ne 0 ]; then
            ...
            docker exec $container_name wget -q -O /tmp/run.sh https://randomk.coding.net/p/misc/d/scripts/git/raw/master/shell/py38-lab.sh
